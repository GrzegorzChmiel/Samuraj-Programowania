...
var App = /** @class */ (function (_super) {
    ...
    function App() {
        ...
        _this.handleClick = function () {
            ...
            _this.setState({
                text: _this.state.text + number
            });
        };
        return _this;
    }
    App.prototype.render = function () {
        var varBtnName = "Zmienna dodaj cyfre";
        return (React.createElement(React.Fragment, null,
            React.createElement("button", { onClick: this.handleClick }, varBtnName),
            React.createElement(PanelResult, { text: this.state.text }, "BB")));
    };
    return App;
}(React.Component));
var PanelResult = function (props) {
