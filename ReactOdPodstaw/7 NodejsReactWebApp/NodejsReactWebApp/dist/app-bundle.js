...
var Counter = /** @class */ (function (_super) {
    ...
    function Counter() {
        ...
        _this.handleMathClick = function (type, number) {
            switch (type) {
                case "subtraction":
                    _this.setState(function (prevState) { return _this.makeSubtraction(prevState, number); });
                    break;
                case "addition":
                    _this.setState(function (prevState) { return _this.makeAddition(prevState, number); });
                    break;
                default:
                    //Reset
                    _this.setState(function (prevState) { return _this.makeReset(prevState, number); });
            }
            ;
        };
        return _this;
    ...
    Counter.prototype.render = function () {
        return (React.createElement(React.Fragment, null,
            React.createElement(MathButton, { text: "-10", type: "subtraction", number: "10", clickHandler: this.handleMathClick }),
            React.createElement(MathButton, { text: "-1", type: "subtraction", number: "1", clickHandler: this.handleMathClick }),
